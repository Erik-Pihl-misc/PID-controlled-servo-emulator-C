...
/********************************************************************************
* tof_read_from_terminal: Reads new TOF sensor value between specified minimum
*                         and maximum from the terminal.
* 
*                         - self: Reference to the TOF sensor.
********************************************************************************/
static inline void tof_read_from_terminal(struct tof* self)
{
   self->val = input_get_double();
   tof_check_sensor_value(self);
   return;
}
